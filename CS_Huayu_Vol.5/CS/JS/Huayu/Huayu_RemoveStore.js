...
var AllRemoveStoreURL = "/Huayu_RemoveStore/AllRemoveStore?wbID=";
function AllRemoveStore(wbID) {
    $.messager.progress();
    $.ajax({
        type: "POST",
        url: AllRemoveStoreURL + encodeURI(wbID),
        data: "",
        async: true,
        cache: false,
...
$(function () {
    ...
    var CheckURL = "/Huayu_RemoveStore/upDateSwbNeedCheck";

    var GetForeStoreCountURL = "/Huayu_RemoveStore/getForeStoreCount?wbID=";
    var GetInOutStoreCountURL = "/Huayu_RemoveStore/getInOutStoreCount?wbID=";
    ...
    var PrintURL = "";
    var QueryURL = "";// "/Huayu_RemoveStore/GetData?txtBeginDate=" + encodeURI($("#txtBeginDate").val()) + "&txtEndDate=" + encodeURI($("#txtEndDate").val()) + "&ddCompany=" + encodeURI(_$_ddCompany.combobox("getValue")) + "&txtCode=" + encodeURI($("#txtCode").val());

    $("#btnQuery").click(function () {
        QueryURL = "/Huayu_RemoveStore/GetData?txtBeginDate=" + encodeURI($("#txtBeginDate").val()) + "&txtEndDate=" + encodeURI($("#txtEndDate").val()) + "&ddCompany=" + encodeURI(_$_ddCompany.combobox("getValue")) + "&txtCode=" + encodeURI($("#txtCode").val());
    ...
    $("#btnPrint").click(function () {
        PrintURL = "/Huayu_RemoveStore/Print?txtBeginDate=" + encodeURI($("#txtBeginDate").val()) + "&txtEndDate=" + encodeURI($("#txtEndDate").val()) + "&ddCompany=" + encodeURI(_$_ddCompany.combobox("getValue")) + "&txtCode=" + encodeURI($("#txtCode").val()) + "&order=" + _$_datagrid.datagrid("options").sortOrder + "&sort=" + _$_datagrid.datagrid("options").sortName + "&page=1&rows=10000000";
    ...
    $("#btnExcel").click(function () {
        ...
        PrintURL = "/Huayu_RemoveStore/Excel?txtBeginDate=" + encodeURI($("#txtBeginDate").val()) + "&txtEndDate=" + encodeURI($("#txtEndDate").val()) + "&ddCompany=" + encodeURI(_$_ddCompany.combobox("getValue")) + "&txtCode=" + encodeURI($("#txtCode").val()) + "&order=" + _$_datagrid.datagrid("options").sortOrder + "&sort=" + _$_datagrid.datagrid("options").sortName + "&page=1&rows=10000000&browserType=" + browserType;
        if (_$_datagrid.datagrid("getData").rows.length > 0) {
    ...
    _$_datagrid.datagrid({
        ...
        onLoadSuccess: function (data) {
            ...
            $.each(allInOutStoreCountSpan_Hid, function (i, item) {
                ...
                $.ajax({
                    ...
                    success: function (msg) {
                        ...
                        if (msg.InStoreCount != "0") {
                            $(".clsInOutStoreCountSpan[wbID=" + wbID + "][InOutStoreType=1]").html(msg.InStoreCount.toString() + "<a href='#' onclick=\"AllRemoveStore('" + encodeURI(wbID) + "');\">全部出库</a>&nbsp;&nbsp;&nbsp;<a href='#' onclick=\"ViewInOutStore('" + encodeURI(wbSerialNum) + "',1);\">指定出库</a>");
                        } else {
                ...
                $.each(allForeStoreCountSpan, function (i, item) {
                    var strRet = "";
                    var wbID = $(item).attr("wbID");
                    var wbSerialNum = $(item).attr("wbSerialNum");
                    $.ajax({
                        ...
                        success: function (msg) {
                            ...
                            //                        if (strRet != "0") {
                            //                            $(item).html(strRet.toString() + "<a href='#' onclick=\"ViewForeStore('" + encodeURI(wbSerialNum) + "');\">入库</a>");
                            //                        } else {
                            //                            $(item).html(strRet.toString());
                            //                        }
