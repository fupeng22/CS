...
namespace CS.Controllers.Huayu
{
    ...
    public class Huayu_RejectWayBillHandlerController : Controller
    {
        ...
        public const string strFileds = "wbStorageDate,wbCompany,wbSerialNum,wbSubNumber,wbTotalWeight,swbTotalNumber,swbTotalWeight,swbTotalActualWeight,wbStatus,releseNum,notReleseNum,TotalRejectSubWayBill,wbImportType,anyOutStore,wbID";
                        ...
                        case "wbStatus":
                            ...
                            if (j != strFiledArray.Length - 1)
                            {
                                if (dt.Rows[i][strFiledArray[j]].ToString() != "")
                                {
                                        ...
                                        case 2:
                                            ...
                                            if (dsReleaseNum_UnReleaseNum != null)
                                            {
                                                ...
                                                if (dtReleaseNum_UnReleaseNum != null && dtReleaseNum_UnReleaseNum.Rows.Count > 0)
                                                {
                                                    ...
                                                    rejectNum = int.Parse(dtReleaseNum_UnReleaseNum.Rows[0]["RejectNum"].ToString());
                                                }
                                            }
                                    ...
                                    if (rejectNum != -1)
                                    {
                                        drCustom["TotalRejectSubWayBill"] = rejectNum.ToString();
                                    }
                                    else
                                    {
                                        drCustom["TotalRejectSubWayBill"] = "无";
                                    }
                                }
